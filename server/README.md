...
Оптимальний варіант для цього додатку — **Tailscale**: працює через CGNAT, має стабільне з'єднання, мінімум налаштувань та безкоштовний план для персонального використання.
...
```json
{"port":8000,"token":"<token>","ips":["192.168.1.10"]}
```
