...
За замовчуванням сервер піднімає **вбудований тунель Cloudflare** (Quick Tunnel) і автоматично завантажує `cloudflared`, щоб не встановлювати VPN/тунель вручну. Публічну адресу можна отримати через:
